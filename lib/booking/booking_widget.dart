  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DestinationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final bookingDestinationsRecord = snapshot.data!;
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Personal Responsible',
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model.membersValueController ??=
                                FormFieldController<String>(null),
                            options: const ['2 Members', '3 Members', '4 Members'],
                            onChanged: (val) =>
                                setState(() => _model.membersValue = val),
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            onChanged: (val) =>
                                setState(() => _model.idTypeValue = val),
                            width: double.infinity,
                            height: 56.0,
                            textStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        formatNumber(
                                          bookingDestinationsRecord.price,
                                        ...
                                        onPressed: () async {
                                          await BookingsRecord.collection
                                              ...
                                              .set(createBookingsRecordData(
                                                ...
                                                name: bookingDestinationsRecord
                                                    .name,
                                                image: bookingDestinationsRecord
                                                    .image,
                                                location:
                                                    bookingDestinationsRecord
                                                        .location,
                                                rating:
                                                    bookingDestinationsRecord
                                                        .rating,
