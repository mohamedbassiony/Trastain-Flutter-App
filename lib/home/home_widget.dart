...
import '/components/updateprofile_widget.dart';
                        ...
                        child: StreamBuilder<List<DestinationsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<DestinationsRecord>
                                listViewDestinationsRecordList = snapshot.data!;

                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              shrinkWrap: true,
                              scrollDirection: Axis.horizontal,
                              itemCount: listViewDestinationsRecordList.length,
                      ...
                      child: StreamBuilder<List<DestinationsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, listViewIndex) {
                              final listViewDestinationsRecord =
                                  listViewDestinationsRecordList[listViewIndex];
                              return Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 20.0),
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        'destinationRef': serializeParam(
                                          listViewDestinationsRecord.reference,
                                          ParamType.DocumentReference,
                                        ),
                                      }.withoutNulls,
                                    );
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                              valueOrDefault<String>(
                                                listViewDestinationsRecord
                                                    .image,
                                                'https://plus.unsplash.com/premium_photo-1681883760386-62d77639384e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTM3fHx0cmF2ZWx8ZW58MHx8MHx8fDA%3D',
                                              ),
                                              width: 86.0,
                                              height: 116.0,
                                              fit: BoxFit.cover,
