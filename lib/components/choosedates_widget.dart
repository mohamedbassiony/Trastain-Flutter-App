...
import 'choosedates_model.dart';
export 'choosedates_model.dart';

class ChoosedatesWidget extends StatefulWidget {
  const ChoosedatesWidget({
    super.key,
  ...
  @override
  State<ChoosedatesWidget> createState() => _ChoosedatesWidgetState();
}

class _ChoosedatesWidgetState extends State<ChoosedatesWidget> {
  late ChoosedatesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoosedatesModel());
