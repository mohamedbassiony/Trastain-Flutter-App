...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF61BA45);
  late Color secondary = const Color(0xFFFCD240);
  late Color tertiary = const Color(0xFFFD5B1F);
  ...
  late Color accent3 = const Color(0xFFC0E685);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFFBFE382);
  late Color warning = const Color(0xFFFCD240);
