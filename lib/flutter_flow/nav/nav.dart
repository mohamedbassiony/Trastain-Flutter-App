...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'triplocationpreview',
          path: '/triplocationpreview',
          builder: (context, params) => TriplocationpreviewWidget(
            destinationRef: params.getParam(
              'destinationRef',
        ...
        FFRoute(
          name: 'triplocationfullpreview',
          path: '/triplocationfullpreview',
          builder: (context, params) => TriplocationfullpreviewWidget(
            destinationRef: params.getParam(
              'destinationRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'searchspecific',
          path: '/searchspecific',
          builder: (context, params) => const SearchspecificWidget(),
        ),
        FFRoute(
          name: 'category',
          path: '/category',
        ...
        FFRoute(
          ...
          path: '/bookingpaymentmethod',
          builder: (context, params) => BookingpaymentmethodWidget(
            destinationRef: params.getParam(
              'destinationRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: 'successful',
          path: '/successful',
          builder: (context, params) => const SuccessfulWidget(),
        ),
        FFRoute(
          name: 'mytrips',
          path: '/mytrips',
